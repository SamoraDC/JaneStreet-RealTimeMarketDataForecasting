# Multi-Model Experiment: strong_oof_subset_s23aux8_s17_gateway_nonlinear_stage3_narrow_control_v1

## Headline

- Best candidate: `fixed_blend_0_w0p75_fixed_blend`.
- Family: `fixed_blend`.
- Global weighted zero-mean R2: `0.014182395`.
- Mean fold R2: `0.013849586`.
- Min fold R2: `0.007763466`.
