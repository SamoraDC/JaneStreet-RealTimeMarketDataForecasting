# Multi-Model Experiment: primary_preprocess_raw9_batchonly_stride100_v1

## Headline

- Best candidate: `latent_alpha_linear_stack`.
- Family: `alpha_latent_stack`.
- Global weighted zero-mean R2: `0.003478307`.
- Mean fold R2: `0.003434425`.
- Min fold R2: `0.000910739`.
...
- Raw preprocessed features: `54`.
- Raw preprocessing modes: `batch_rank, batch_demean, batch_zscore, batch_abs_zscore, batch_top_bottom`.
