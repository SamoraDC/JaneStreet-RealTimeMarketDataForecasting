# Multi-Model Experiment: strong_oof_hist_max1398_gateway_signed_square_v1

## Headline

- Best candidate: `fixed_blend_5_w0p5_fixed_blend`.
- Family: `fixed_blend`.
- Global weighted zero-mean R2: `0.015588215`.
- Mean fold R2: `0.015356614`.
- Min fold R2: `0.012878134`.
