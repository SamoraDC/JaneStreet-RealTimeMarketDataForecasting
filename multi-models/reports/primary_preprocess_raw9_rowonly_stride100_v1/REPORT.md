# Multi-Model Experiment: primary_preprocess_raw9_rowonly_stride100_v1

## Headline

- Best candidate: `latent_alpha_linear_stack`.
- Family: `alpha_latent_stack`.
- Global weighted zero-mean R2: `0.003404854`.
- Mean fold R2: `0.003400262`.
- Min fold R2: `0.001170107`.
...
- Raw preprocessed features: `3`.
- Raw preprocessing modes: `row_missing_count, row_abs_mean, row_l2_energy`.
