# Multi-Model Experiment: strong_oof_subset_s23aux8_s17_gateway_batch_demean_zscore_smoke_stride5_comparable_v1

## Headline

- Best candidate: `strong_oof_ridge_stack`.
- Family: `strong_stack`.
- Global weighted zero-mean R2: `0.014162012`.
- Mean fold R2: `0.013830658`.
- Min fold R2: `0.008015482`.
