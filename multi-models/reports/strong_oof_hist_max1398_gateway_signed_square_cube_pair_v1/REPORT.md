# Multi-Model Experiment: strong_oof_hist_max1398_gateway_signed_square_cube_pair_v1

## Headline

- Best candidate: `fixed_blend_5_w0p5_fixed_blend`.
- Family: `fixed_blend`.
- Global weighted zero-mean R2: `0.015618964`.
- Mean fold R2: `0.015386503`.
- Min fold R2: `0.012831522`.
