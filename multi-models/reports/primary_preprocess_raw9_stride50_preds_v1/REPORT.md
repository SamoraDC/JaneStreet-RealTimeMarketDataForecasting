# Multi-Model Experiment: primary_preprocess_raw9_stride50_preds_v1

## Headline

- Best candidate: `latent_alpha_linear_stack`.
- Family: `alpha_latent_stack`.
- Global weighted zero-mean R2: `0.003859523`.
- Mean fold R2: `0.003712643`.
- Min fold R2: `0.000314330`.
