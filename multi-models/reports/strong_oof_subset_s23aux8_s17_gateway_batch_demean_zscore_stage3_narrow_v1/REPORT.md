# Multi-Model Experiment: strong_oof_subset_s23aux8_s17_gateway_batch_demean_zscore_stage3_narrow_v1

## Headline

- Best candidate: `fixed_blend_0_w0p75_fixed_blend`.
- Family: `fixed_blend`.
- Global weighted zero-mean R2: `0.014382132`.
- Mean fold R2: `0.014067439`.
- Min fold R2: `0.008048615`.
