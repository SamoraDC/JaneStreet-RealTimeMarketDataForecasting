# Multi-Model Experiment: strong_oof_subset_s23aux8_s17_gateway_signed_square_abs_stage3_v1

## Headline

- Best candidate: `fixed_blend_0_w0p5_fixed_blend`.
- Family: `fixed_blend`.
- Global weighted zero-mean R2: `0.014086923`.
- Mean fold R2: `0.013734496`.
- Min fold R2: `0.007428086`.
