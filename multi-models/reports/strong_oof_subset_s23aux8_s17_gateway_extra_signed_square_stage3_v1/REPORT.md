# Multi-Model Experiment: strong_oof_subset_s23aux8_s17_gateway_extra_signed_square_stage3_v1

## Headline

- Best candidate: `fixed_blend_0_w0p5_fixed_blend`.
- Family: `fixed_blend`.
- Global weighted zero-mean R2: `0.014038266`.
- Mean fold R2: `0.013682770`.
- Min fold R2: `0.007451090`.
