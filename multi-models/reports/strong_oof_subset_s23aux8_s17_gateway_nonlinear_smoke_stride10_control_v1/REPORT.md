# Multi-Model Experiment: strong_oof_subset_s23aux8_s17_gateway_nonlinear_smoke_stride10_control_v1

## Headline

- Best candidate: `strong_oof_ridge_stack_prediction_s0_risk_shrink`.
- Family: `risk_shrinkage`.
- Global weighted zero-mean R2: `0.014174610`.
- Mean fold R2: `0.013856921`.
- Min fold R2: `0.007882401`.
