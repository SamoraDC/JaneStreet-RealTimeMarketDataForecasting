# Multi-Model Experiment: strong_oof_stage3_gateway_residual_tail_modes_v1

## Headline

- Best candidate: `gateway_risk_aggressive_rls_abs_pred_s25_prediction`.
- Family: `strong_base`.
- Global weighted zero-mean R2: `0.013881135`.
- Mean fold R2: `0.013493024`.
- Min fold R2: `0.006963629`.
