# Multi-Model Experiment: primary_preprocess_raw9_stride20_preds_v1

## Headline

- Best candidate: `latent_alpha_linear_stack`.
- Family: `alpha_latent_stack`.
- Global weighted zero-mean R2: `0.004044042`.
- Mean fold R2: `0.004010716`.
- Min fold R2: `0.001122013`.
