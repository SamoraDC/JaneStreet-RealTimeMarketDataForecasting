# Multi-Model Experiment: strong_oof_contextual_blend_smoke_stride200_stream_v1

## Headline

- Best candidate: `aggressive_rls_prediction`.
- Family: `strong_base`.
- Global weighted zero-mean R2: `0.014739156`.
- Mean fold R2: `0.014222489`.
- Min fold R2: `0.004470929`.
