# Multi-Model Experiment: strong_oof_subset_s23aux8_s17_gateway_batch_rank_only_smoke_stride5_v1

## Headline

- Best candidate: `strong_oof_ridge_stack`.
- Family: `strong_stack`.
- Global weighted zero-mean R2: `0.013996712`.
- Mean fold R2: `0.013607022`.
- Min fold R2: `0.007370199`.
