# Multi-Model Experiment: strong_oof_subset_w010_s23aux8_stage3_v1

## Headline

- Best candidate: `fixed_blend_1_w0p5_fixed_blend`.
- Family: `fixed_blend`.
- Global weighted zero-mean R2: `0.013991272`.
- Mean fold R2: `0.013620918`.
- Min fold R2: `0.007258938`.
