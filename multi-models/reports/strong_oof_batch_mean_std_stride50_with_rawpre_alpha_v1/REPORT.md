# Multi-Model Experiment: strong_oof_batch_mean_std_stride50_with_rawpre_alpha_v1

## Headline

- Best candidate: `strong_oof_ridge_stack`.
- Family: `strong_stack`.
- Global weighted zero-mean R2: `0.014118022`.
- Mean fold R2: `0.013874299`.
- Min fold R2: `0.008139189`.
