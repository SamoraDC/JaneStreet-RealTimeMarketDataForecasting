# Multi-Model Experiment: strong_oof_subset_s23aux8_s17_gateway_sign_stage3_v1

## Headline

- Best candidate: `fixed_blend_1_w0p5_fixed_blend`.
- Family: `fixed_blend`.
- Global weighted zero-mean R2: `0.014042862`.
- Mean fold R2: `0.013701710`.
- Min fold R2: `0.007463324`.
