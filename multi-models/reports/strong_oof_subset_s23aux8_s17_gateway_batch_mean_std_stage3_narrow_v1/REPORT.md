# Multi-Model Experiment: strong_oof_subset_s23aux8_s17_gateway_batch_mean_std_stage3_narrow_v1

## Headline

- Best candidate: `fixed_blend_0_w0p75_fixed_blend`.
- Family: `fixed_blend`.
- Global weighted zero-mean R2: `0.014424969`.
- Mean fold R2: `0.014106538`.
- Min fold R2: `0.008046149`.
