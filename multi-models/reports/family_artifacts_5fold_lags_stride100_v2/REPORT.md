# Multi-Model Experiment: family_artifacts_5fold_lags_stride100_v2

## Headline

- Best candidate: `latent_alpha_linear_stack`.
- Family: `alpha_latent_stack`.
- Global weighted zero-mean R2: `0.003324014`.
- Mean fold R2: `0.003305691`.
- Min fold R2: `0.000957903`.
