# Multi-Model Experiment: strong_oof_subset_s23aux8_s17_gateway_nonlinear_smoke_stride5_control_v1

## Headline

- Best candidate: `strong_oof_ridge_stack_prediction_s0_risk_shrink`.
- Family: `risk_shrinkage`.
- Global weighted zero-mean R2: `0.014071661`.
- Mean fold R2: `0.013733413`.
- Min fold R2: `0.007881659`.
