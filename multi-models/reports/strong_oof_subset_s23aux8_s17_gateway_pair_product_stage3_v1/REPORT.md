# Multi-Model Experiment: strong_oof_subset_s23aux8_s17_gateway_pair_product_stage3_v1

## Headline

- Best candidate: `fixed_blend_1_w0p75_fixed_blend`.
- Family: `fixed_blend`.
- Global weighted zero-mean R2: `0.014104546`.
- Mean fold R2: `0.013769719`.
- Min fold R2: `0.007640547`.
