# Multi-Model Experiment: strong_oof_batch_mean_std_stride50_control_join_rawpre_v1

## Headline

- Best candidate: `strong_oof_ridge_stack`.
- Family: `strong_stack`.
- Global weighted zero-mean R2: `0.014119788`.
- Mean fold R2: `0.013880141`.
- Min fold R2: `0.008297576`.
