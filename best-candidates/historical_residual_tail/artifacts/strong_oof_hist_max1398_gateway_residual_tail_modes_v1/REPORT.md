# Multi-Model Experiment: strong_oof_hist_max1398_gateway_residual_tail_modes_v1

## Headline

- Best candidate: `gateway_risk_conservative_rls_abs_pred_s100_prediction_residual_weight_and_abs_q0p95_residual_tail`.
- Family: `residual_tail`.
- Global weighted zero-mean R2: `0.015630171`.
- Mean fold R2: `0.015416460`.
- Min fold R2: `0.012909970`.
